while True:
    ...
    if salario_float <= 2000.00:
        ...
        imposto_8_porcento = (salario_float - 2000.00) * 0.08 
        print(f'Deve pagar R$ {imposto_8_porcento:.2f} de imposto.')

    elif salario_float >= 3000.01 and salario_float <= 4500.00:
        imposto_18_porcento = (((salario_float - 2000.00) - 1000.00) * 0.18) + (1000.00 * 0.08)
        print(f'Deve pagar R$ {imposto_18_porcento:.2f} de imposto.')

    else:
        imposto_28_porcento = ((((salario_float - 2000.00)-1000.00)-1500.00) * 0.28) + ((1000.00 *0.08)+(1500.00 * 0.18))
